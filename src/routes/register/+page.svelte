...
<form method="post" id="form">
  <div class="absolute left-1/2 top-1/2 w-full max-w-[100rem] -translate-x-1/2 -translate-y-1/2 space-y-6 px-4 py-8 sm:px-8 md:px-16 lg:px-32 xl:px-48 2xl:px-72">
    <FormQuestionContainer title="Register" description="Only authorised staff members may register">
      ...
      <Input label="Secret" placeholder="············" name="secret" size="medium" type="password" />
    </FormQuestionContainer>

    <div class="flex justify-end">
      <SubmitButton text="Register" disabled={false} />
    </div>
  </div>
</form>
